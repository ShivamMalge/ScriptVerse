        ...
        <div className="flex flex-wrap justify-center gap-4 mb-16">
          {Object.entries(services).map(([key, service]) => (
            <Button
              ...
              className={`
                px-6 py-6 text-lg font-medium transition-all duration-300
                ${
                  activeTab === key
        ...
        >
          <div className={`p-1 bg-gradient-to-r ${activeService.color}`}>
            <div className="bg-black p-8 md:p-12">
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-6 tracking-tighter">{activeService.title}</h2>
              <p className="text-xl text-gray-300 mb-10 font-mono">{activeService.description}</p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                {activeService.features.map((feature, index) => (
                  ...
                  >
                    <div
                      className={`inline-flex items-center justify-center w-12 h-12 mb-4 bg-gradient-to-br ${activeService.color} text-black`}
                    >
                      {feature.icon}
                    </div>
      ...
      <section className="w-full px-4 mx-auto py-24 bg-black">
        ...
        <div className="relative max-w-4xl mx-auto">
          ...
          {[
            ...
            {
              title: "Strategy",
              description: "Our team develops a comprehensive roadmap tailored to your specific needs and objectives.",
            },
            {
              title: "Design",
